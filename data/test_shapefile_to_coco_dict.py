...
import cv2
from register_shapefile_datatset import shapefile_to_coco_dict
from detectron2.data import MetadataCatalog

classes, dataset_dicts = shapefile_to_coco_dict("/Users/Ro/Google Drive/UBC_EngCapstone/sample_data/CPT2a-n")
